 ...
 <div class="tab-pane fade show active" id="v-pills-furniture" role="tabpanel" aria-labelledby="v-pills-furniture-tab">
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            ...
                                            <div   class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a >Fall of Sensitivity</a></h5>
                                                <ul class="rating">
                                    ...
                                    <div>
                                    <span>
                                    Having engaged subjects as diverse as the civil rights movement, southern rock music and modernist architecture, my work reproduces familiar visual and aural signs
                                    </span>
                                    </div>
                                    </div>
                                    </div>
